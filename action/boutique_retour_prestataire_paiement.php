...
function action_boutique_retour_prestataire_paiement_dist(){
	
	include_spip('inc/headers');
	
	$contexte = array();
	
	spip_log("INFO Retour d'une commande","boutique");
	
	$contexte['token_retour_paiement'] = _request("token_retour_paiement");
	
	$retour = sql_select("*","spip_boutique_tokens_retour","token_retour = '".$contexte['token_retour_paiement']."'");
